                                            	...
                                            	<div class="panel-body">
											        <form id="registryForm" name="registryForm" class="form-horizontal teacher" action="" method="post" enctype="multipart/form-data">
											        	<div class="control-group">
													          <div class="controls">
													            <label class="control-label">登录帐号：&nbsp;&nbsp;</label><input  class="input-large bui-form-field required"   type="text" name="loginId" placeholder="请输入您的登录帐号" >
													          </div>
												          </div>
												          <div class="control-group">
													          <div class="controls">
												          ...
												          <div class="control-group">
													          <div class="controls">
													             <label >手机号码：&nbsp;&nbsp;</label><input class="input-large bui-form-field required number" type="text" name="mobileNum" id="mobileNum" placeholder="您的真实手机号"  >
													          </div>
												          </div>
												          <div class="control-group">
													          <div class="controls">
													      ...
													      <div class="control-group">
												           ...
												           <div class="control-group">
													          <div class="controls">
													            ...
													            <input id="uploadPhoto" type="button" value="上传照片"/>
													          </div>
												          </div>
